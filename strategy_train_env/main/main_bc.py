...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train BC bidding strategy")
    ...
    run_bc(train_data_path=args.data, step_num=args.steps, batch_size=args.batch_size,
           save_dir=args.save, device=args.device, multi_gpu=args.multi_gpu)
    test_checkpoints('bc', args.save or 'saved_model/BCtest', args.test_data)
